...
if (!isset($_SESSION['user_id']) || !in_array($_SESSION['role'], ['admin', 'campaign_owner'])) {
    die("Μη εξουσιοδοτημένη πρόσβαση.");
}

$pageTitle = 'Διαχείριση Καμπανιών';
?>
<!DOCTYPE html>
    ...
    <nav class="navbar navbar-expand-lg glass-navbar fixed-top">
        <div class="container-fluid px-4">
            <a class="navbar-brand d-flex align-items-center gap-2" href="dashboard.php">
                <i class="ri-rocket-line fs-4 text-primary"></i>
                <span class="fw-bold">Καμπάνιες</span>
            </a>
